Pod::Spec.new do |s|
  ...
  s.source           = { :http => "https://github.com/uniappplug/iosuts-specs/releases/download/FFmpegUnix-v1.0.0/FFmpegUnix-1.0.0.zip"}
  s.ios.deployment_target = '12.0'

  s.pod_target_xcconfig = { 'OTHER_LDFLAGS' => ['-lObjC'] }
  s.libraries = 'resolv', 'iconv'
  s.vendored_frameworks =["FFmpegUnix/ffmpegkit.framework",
